...
import Appium.reports.ExtentTestFactoryParent;
...
public class BaseTestConfig extends RetryAnalyzer {
    ...
    public void loadExtentFile() {
        System.out.print("Loading extent file");
        filePath = System.getProperty("user.dir") + "//Reports//ExtentReport.html";
        new File(filePath);
...
//        commandToRun("adb logcat -c");
    ...
    private static ExtentHtmlReporter getHtmlReporter() {
        ...
        htmlReporter.loadXMLConfig(System.getProperty("user.dir") + "//caps//extent-config.xml");
        htmlReporter.config().setDocumentTitle("DealShare-Automation");
